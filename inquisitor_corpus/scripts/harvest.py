...
CSV_IN = Path("/home/user/workspace/inquisitor_research/inquisitor_master_sources.csv")

# Two UA profiles: bot UA for Wikipedia (preferred there), browser UA for mil/.gov hosts that block bots
UA_BOT = "InquisitorCorpusBot/1.0 (research/educational; contact: omnissiahcypher@github)"
...
BROWSER_HOSTS = {
    ...
    "www.dni.gov", "dni.gov",
    "www.intelligence.gov", "intelligence.gov",
    "www.rand.org", "rand.org",
    "www.cnas.org", "cnas.org",
    "www.csbaonline.org", "csbaonline.org",
    "www.csis.org", "csis.org",
    "www.aspi.org.au", "aspi.org.au",
    "www.understandingwar.org", "understandingwar.org",
    "www.fpri.org", "fpri.org",
    "ctc.westpoint.edu",
    "www.atlanticcouncil.org", "atlanticcouncil.org",
    "www.brookings.edu", "brookings.edu",
    "www.heritage.org", "heritage.org",
    "www.washingtoninstitute.org", "washingtoninstitute.org",
    "www.thesoufancenter.org", "thesoufancenter.org",
    "www.longwarjournal.org", "longwarjournal.org",
    "www.criticalthreats.org", "criticalthreats.org",
    "www.iranprimer.usip.org", "iranprimer.usip.org", "usip.org",
    "www.nti.org", "nti.org",
    "www.iiss.org", "iiss.org",
    "www.usni.org",
    "www.38north.org", "38north.org",
    "beyondparallel.csis.org",
    "www.armywarcollege.edu", "armywarcollege.edu",
    "press.armywarcollege.edu",
    "ssi.armywarcollege.edu",
    "ndupress.ndu.edu",
    "digital-commons.usnwc.edu",
    "smallwarsjournal.com", "www.smallwarsjournal.com",
    "warontherocks.com", "www.warontherocks.com",
    "mwi.westpoint.edu",
    "www.rusi.org", "rusi.org",
    "icct.nl", "www.icct.nl",
    "ifmat.org", "www.ifmat.org",
    "iranwatch.org", "www.iranwatch.org",
    "almaresearch.org",
    "scramble.nl", "www.scramble.nl",
    "fas.org", "irp.fas.org",
    "mappingmilitants.org",
    "project2049.net",
    "tnsr.org", "www.tnsr.org",
